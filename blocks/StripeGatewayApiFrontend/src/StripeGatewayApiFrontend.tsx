...
import StripeGatewayApiFrontendController, {
  Props,
  configJSON,
} from "./StripeGatewayApiFrontendController";

export default class StripeGatewayApiFrontend extends StripeGatewayApiFrontendController {
